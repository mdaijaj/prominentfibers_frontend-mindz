...
else if(this.urll2=='/master/expense-main/travel-request/Draft-travel'){
  this.openDrafIcon=true;
  }
...
this.getByZip()
  ...
  getValueToDisplay(params: ICellRendererParams) {
    ...
    this.selectAgent=params.data.select_agent
    this.travelExpenseId=params.data.expense_id;
    console.log(this.travelExpenseId);
  ...
  if (params.data.status === 'ManageApproval') {
    ...
    if (params.data.statusInvoice === 'Update Invoice') {
    this.updateInvoice = true;
  }

  if(params.data.travel_id){
    if(params.data.status==="Suggested"){
    this.travelDetailChild=true;
    }
...
//   if(params.data.expense_status==="draft"){
// this.draftStatus=true;
//   }


  if(params.data.expense_type==="Billable"){
this.billableStatus=true;
  }else if(params.data.expense_type==="Non-Billable"){
this.nonBillableStatus=true;
  ...
  edit(e:any){
    e.stopPropagation();
    this.router.navigate(["master/expense-main/travel-request/travel-request/create-request"],{queryParams:{lead_id:this.cellValue }})
  }
  editConfirm(){
    this.router.navigate(["master/expense-main/travel-request/travel-request/confirm-travel-request"],{queryParams:{lead_id:this.cellValue}})
  }
 
  editBook(){
    this.router.navigate(["master/expense-main/travel-request/travel-request/book-travel-request"],{queryParams:{lead_id:this.cellValue}})
  ...
  createTravel() {
    this.router.navigate(["master/expense-main/travel-request/travel-request/create-request"],{queryParams:{task_lead_id:this.cellValue}})
  }
  validate(e: any) {
    e.stopPropagation();
  ...
  cancelTicket(e: any) {
    e.stopPropagation();
    this.router.navigate(["master/expense-main/travel-request/travel-request/cancel-reuest"],{queryParams:{lead_id:this.cellValue}})
  }
  cancelTicketReuest(e: any) {
    e.stopPropagation();
    this.router.navigate(["master/expense-main/travel-request/travel-request/cancel-ticket_approved"],{queryParams:{lead_id:this.cellValue}})
  }
  ...
  downloadTickets(e: any) {
    e.stopPropagation();
    this.router.navigate(["master/expense-main/travel-request/travel-request/download-ticket"],{queryParams:{lead_id:this.cellValue}})
  }

  draftUpdate(e:any){
    e.stopPropagation();
    this.router.navigate(["master/expense-main/travel-request/Draft-travel/draft-travel-update"],{queryParams:{lead_id:this.travelExpenseId}})
  }
