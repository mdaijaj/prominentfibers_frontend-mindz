...
@Component({
  selector: 'app-approved-reject-list',
  templateUrl: './approved-reject-list.component.html',
  styleUrls: ['./approved-reject-list.component.scss']
})
export class ApprovedRejectListComponent {
  ...
  // }
  getListExpense(){
    this._itteketService.getApprovedRejectTravel().subscribe((res:any)=>{
