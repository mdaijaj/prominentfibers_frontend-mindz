...
export class ToBeAppActionComponent {
  ...
  proceedToApp(e:any) {
    ...
    this.router.navigate(['master/itticket/purchase-inventory/purchase-request/all-pr-list/create-pr'], { queryParams: { pr_id: this.cellValue.data.procurement_id, status:  'to_be_app'}})
  }
}
