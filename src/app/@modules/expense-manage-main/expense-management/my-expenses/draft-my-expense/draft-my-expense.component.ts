...
@Component({
  selector: 'app-draft-my-expense',
  templateUrl: './draft-my-expense.component.html',
  styleUrls: ['./draft-my-expense.component.scss']
})

export class DraftMyExpenseComponent {
  ...
  // }
  getListExpense(){
    this.leadService.myExpenseDraftGet().subscribe((res:any)=>{
