...
@Component({
  ...
  templateUrl: './approve-expense-list.component.html',
  styleUrls: ['./approve-expense-list.component.scss']
})
export class ApproveExpenseComponent {
  ...
  getListExpense(){
    this._itteketService.getPending().subscribe((res:any)=>{
  ...
  public columnDefs = [
    ...
    },
    {
      ...
      cellStyle: function (params: any) {
        if (params.value.toLowerCase() == 'Pending'.toLowerCase()) {
          return { color: 'orange' };
        }else if (params.value.toLowerCase() == 'Approved'.toLowerCase()) {
          return { color: 'blue' };
        }else if (params.value.toLowerCase() == 'Paid'.toLowerCase()) {
          return { color: 'green' };
        }
