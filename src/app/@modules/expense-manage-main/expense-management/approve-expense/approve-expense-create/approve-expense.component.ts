...
@Component({
  selector: 'app-approve-expense-create',
  templateUrl: './approve-expense.component.html',
  styleUrls: ['./approve-expense.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class ApproveExpenseCreateComponent {
  ...
  constructor(private fb: FormBuilder,
    ...
    this.expenceForm = this.fb.group({
      ...
      remarks_posted: new FormControl('', Validators.required),
    })
 ...
 Swal.fire({
      title: 'Are you sure to Approved this Expense ?',
