...
@Component({
  selector: 'app-esi-action',
  templateUrl: './esi-action.component.html',
  styleUrls: ['./esi-action.component.scss']
})
export class EsiActionComponent implements OnInit {
  cellValue: any;
  ...
  pfDelete (e: any) {
      e.stopPropagation();
      Swal.fire({
        title: 'Are you sure to delete this ESI Details ?',
    ...
    edit(e: any) {
      e.stopPropagation();
      this.route.navigate(['master/hrms/payroll/payroll-master/payroll-component/esi-create'],
